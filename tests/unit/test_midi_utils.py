...
class TestMidiUtils(unittest.TestCase):
    ...
    @preset('midi_utils.MidiUtils.get_midi_ports', side_effect=Exception("Test exception"))
    ...
    @preset('midi_utils.MidiUtils._send_rtmidi_message')
    ...
    @preset('midi_utils.MidiUtils.is_midi_available')
    ...
    @preset('midi_utils.MidiUtils.send_midi_command')
    @preset('asyncio.get_event_loop')
