            ...
            with open('/etc/os-release', 'r') as f:
                ...
                if 'Ubuntu' in content:
                    if '24.04' in content:
                        ...
                        print("⚠️  Older Ubuntu detected - CI uses 24.04 with different packages")
                        print("💡 If Qt issues occur, try: sudo apt install libgl1-mesa-dri")
                    else:
